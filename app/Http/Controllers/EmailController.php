...
class EmailController extends Controller
{
    ...
    public static function userSubscription($user=array(), $data=array()) {
       
        //$controller = new controller();
        $emailContent = EmailTemplate::where('id', 3)->get()->first();
        ...
        $expire = date('d/m/Y', $data->sub_expire);

        $search = array('{NAME}', '{PLAN}', '{EXPIRE}', '{DURATION}', '{AMOUNT}', '{BENEFITS}');
        $replace = array($user->name, $data->module, $expire, $data->duration, $data->coin_amount, $data->benefits);
    ...
    public static function subscriptionExpirationChecker($user=array(), $data=array()) {
       
        //$controller = new controller();
        $emailContent = EmailTemplate::where('id', 4)->get()->first();
    ...
    public static function subscriptionExpiredChecker($user=array(), $data=array()) {
       
        //$controller = new controller();
        $emailContent = EmailTemplate::where('id', 5)->get()->first();
        ...
        $search = array('{NAME}', '{PLAN}', '{EXPIRE}', '{DURATION}', '{AMOUNT}');
        $replace = array($user->name, $data->module, $expire, $data->duration, $data->coin_amount);
