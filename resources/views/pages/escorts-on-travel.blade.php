...
<body id="index" class="index hide-left-column hide-right-column lang_en  one-column">	    
  ...
  <div class="columns-container">
      <div id="columns">
        ...
        <div class="wrapper it_DGITDWJZLEXM container">
          <div class="row it_THBLKFZBZGDC ">
          <div class="it_FMSUBFQQKNTC col-xs-12    ">
          <div class="module ">  <h4 class="homefeatured-heading">Escorts on travel</h4>
            ...
            <!-- Products list -->
            <ul id="homefeatured" class="product_list grid row homefeatured tab-pane escorts-on-travel-loader">
