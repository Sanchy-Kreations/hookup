...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('News user form') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ action('App\Http\Controllers\PagesController@createUser')}}">
                        @csrf
    ...
    @foreach ($users as $user)
        <div class="cnt cnt-body">
            <div class="row center">
                ...
                <div class="col-md-4 col-sm-4">
         <h4>{{$user->name}}</h4>
         @if ($user->admin == Auth::user()->id)
         <a href="{{ url('dashboard/delete_user/'.$user->id) }}" class="btn btn-danger"> Delete </a>
         @endif        
        </div>
        </div>
    @endforeach
